...
public class Property {
	...
	public Property(int propertyID, Address address, PropertyType propertyType, boolean elevator, String description, boolean balcony, boolean airConditioned, double heigth, int size, int numberOfRooms) {
